"""Daily AGIX market price from Yahoo (no key). ETF — trades AT/NEAR NAV via create/redeem."""
...
from config import AgixKraneshares as CFG  # noqa: E402

_RAW = os.path.join(_REPO_ROOT, "situations", "agix_kraneshares", "data", "raw")
