"""Daily ARKVX NAV from Yahoo (no key). Interval fund priced daily at NAV (= price)."""
...
from config import ArkvxArkVenture as CFG  # noqa: E402

_RAW = os.path.join(_REPO_ROOT, "situations", "arkvx_arkventure", "data", "raw")
