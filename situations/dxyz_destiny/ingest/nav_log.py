"""DXYZ NAV log — Destiny publishes NAV quarterly. cowork/bookmarklet appends; merge with seed."""
import json, os, sys

_REPO_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
if _REPO_ROOT not in sys.path:
    sys.path.insert(0, _REPO_ROOT)
from config import DxyzDestiny as CFG  # noqa: E402

_SRC = "https://www.cefconnect.com/fund/DXYZ"
...
def read_log():
    ...
    for ln, raw in enumerate(open(path, encoding="utf-8"), 1):
        ...
        try:
            ...
            print("[dxyz nav_log] skip line %d: %s" % (ln, e))
    return out
