"""EDGAR ingest for Robinhood Ventures Fund I (RVI), CIK 2085091. NPORT-P net assets + holdings.
RVI names its holdings DIRECTLY (no SPV codenames) — the cleanest disclosure of the CEF set."""
import json, os, re, sys, time, urllib.request

_REPO_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
if _REPO_ROOT not in sys.path:
    sys.path.insert(0, _REPO_ROOT)
from config import RviRobinhood as CFG, SEC_USER_AGENT  # noqa: E402

_RAW = os.path.join(_REPO_ROOT, "situations", "rvi_robinhood", "data", "raw", "edgar")
